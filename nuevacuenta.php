...
<body class="quicksand"> 
    ...
    <section id="form" class="container my-3">
        <h2 class="mb-3 text-center titulo-azul"><b>Registro para empleados</b></h2>
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                <form action="#" method="POST" class="border p-3 rounded shadow-sm bg-light">
                    ...
                    <div class="mb-3">
                        <label for="direccion" class="form-label">Correo electrónico:</label>
                    ...
                    <div class="mb-3">
                        <label for="puesto" class="form-label">Puesto del empleado:</label>
                        <select id="puesto" name="puesto" class="form-select" required>/
                            <option value="">Seleccione un puesto dentro de la empresa</option>
                            <option value="filtro_basico">Técnico</option>
                            <option value="filtro_avanzado">Gerente</option>
                        </select>
                    </div>
                    <div class="d-grid">
                        <button id="enviarReg" name="enviarReg" type="submit" class="btn btn-primary btn-block">Registrar</button>
                    </div>
                </form>
            </div>
        </div>
